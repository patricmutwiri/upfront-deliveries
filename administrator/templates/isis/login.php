...
<body class="site <?php echo $option . ' view-' . $view . ' layout-' . $layout . ' task-' . $task . ' itemid-' . $itemid . ' '; ?>">
	...
	<div class="navbar<?php echo $color_is_light ? ' navbar-inverse' : ''; ?> navbar-fixed-bottom hidden-phone">
		...
		<a class="login-joomla hasTooltip" href="patric.xyz" target="_blank"  rel="noopener noreferrer" title="Patrick Mutwiri, Fullstack Developer, based in Nairobi Kenya"><span class="icon-link"></span></a>
